...
a persistence unit "eva62PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "eva62/pom.xml":
...
artifact ("eva62.war") is already built. You can build
